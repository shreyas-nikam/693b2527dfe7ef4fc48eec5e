...
if 'report_group_by' not in st.session_state:
    st.session_state.report_group_by = 'job_role'
...
if st.session_state.current_page == "Dashboard":
    ...
    if st.button("Simulate Pathway Impact"):
        if st.session_state.selected_employee_id_whatif != "N/A" and st.session_state.selected_pathway_id_whatif != "N/A":
            ...
            projected_ai_r, delta_ai_r, pathway_name_res = simulate_pathway_impact(
                ...
                st.session_state.master_score_whatif, # This was a bug in original code where 'mastery_score_whatif' was misspelled.
            ...
            st.session_state.whatif_results = {
                ...
                "selected_employee_id": st.session_state.selected_employee_id_whatif
            }
        else:
    ...
    if st.session_state.whatif_results and st.session_state.whatif_results["selected_employee_id"] == st.session_state.selected_employee_id_whatif:
        ...
        st.markdown(r"Change in AI-R ($\Delta$AI-R): **{:.2f}**".format(res['delta_ai_r']))
    ...
    if st.button("Optimize Pathways"):
        if st.session_state.selected_employee_id_opt != "N/A":
            ...
            st.session_state.optimization_results = {
                ...
                "selected_employee_id": st.session_state.selected_employee_id_opt,
    ...
    if st.session_state.optimization_results and st.session_state.optimization_results["selected_employee_id"] == st.session_state.selected_employee_id_opt:
        ...
        st.markdown(f"Projected Final AI-R: **{opt_res['project_final_ai_r']:.2f}**")
    ...
    st.markdown(r"For individual $i$ targeting occupation $o_{target}$ at time $t$:")
    ...
    st.subheader(r"Base Opportunity Score ($H_{\text{base}}$)")
    ...
    st.subheader(r"Dynamic Multipliers: Growth & Regional")
    st.markdown(r"Beyond the static Base Opportunity Score, Systematic Opportunity is modulated by dynamic, time-varying market factors:")
